...
I am interested in `control`, `optimization`, `dynamics` and `robot learning`. I am developing efficient optimization-based planning algorithms for real-time embedded systems.
